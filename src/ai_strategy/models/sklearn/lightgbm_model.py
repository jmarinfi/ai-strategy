...
class LightGBMModel:
    ...
    def prepare_data_for_training(
        ...
        print(
            f"   Future price (row 0, should be row {horizon}): {df['future_price'].iloc[0]:.2f}"
        )
        print(
            f"   Future price (row 100, should be row {100+horizon}): {df['future_price'].iloc[100]:.2f}"
        )
    ...
    def _optimize_hyperparameters(
        self, X_train: pd.DataFrame, y_train: pd.Series, n_trials: int = 50, n_splits: int = 3
    ) -> dict[str, Any]:
